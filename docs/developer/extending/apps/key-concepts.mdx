...
To create an app that reacts to payment webhook, first you need to create a regular app as described in [this dashboard manual](/dashboard/apps.md). Make sure to make the app active and grant it the `MANAGE_PAYMENTS` permission.
